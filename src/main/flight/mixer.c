...
static void applyRpmLimiter(mixerRuntime_t *mixer)
{
    ...
    DEBUG_SET(DEBUG_RPM_LIMIT, 4, lrintf(dynamicActivate * 1.0f)); //текущее 6 AUX канала
    DEBUG_SET(DEBUG_RPM_LIMIT, 5, lrintf(dynamicActivate * 1.0f)); //текущее 6 AUX канала
    //New test  v2
}
#endif // USE_RPM_LIMIT
