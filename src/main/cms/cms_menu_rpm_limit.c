...
static const OSD_Entry cmsx_menuRpmLimitEntries[] =
{
    ...
    {"MIN RPM", OME_UINT16, NULL, &(OSD_UINT16_t){ &min_dynamic_rpm_limit_value, 0, UINT16_MAX, 100}}, // тут можно задать MAX значение
    {"MAX RPM", OME_UINT16, NULL, &(OSD_UINT16_t){ &max_dynamic_rpm_limit_value, 0, UINT16_MAX, 100}}, // тут можно задать MIN значение
